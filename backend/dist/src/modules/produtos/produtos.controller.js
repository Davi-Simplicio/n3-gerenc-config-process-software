...
let ProdutosController = class ProdutosController {
    ...
    create(createProdutoDto) { return this.produtosService.create(createProdutoDto); }
    findAll(page = '0', size = '10') { return this.produtosService.findAll(+page, +size); }
...
__decorate([
    ...
    __metadata("design:paramtypes", [produto_dto_1.CreateProdutoDto]),
    __metadata("design:returntype", void 0)
], ProdutosController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar produtos com paginação' }),
